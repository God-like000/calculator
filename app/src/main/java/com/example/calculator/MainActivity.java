...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    Button bt_num0,bt_num1,bt_num2,bt_num3,bt_num4,bt_num5,bt_num6,bt_num7,
            bt_num8,bt_num9,bt_delete,bt_div,bt_mult,bt_minus,bt_plus,bt_equal,bt_dot,bt_clear,bt_tran;
    ...
    private void initViewAndListener() {
        ...
        bt_tran = (Button)findViewById(R.id.bt_tran);
        bt_tran.setOnClickListener(this);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.bt_delete:
                ...
                break;
            //正负切换按钮，若当前内容非空，提供正负切换
            case R.id.bt_tran:
                if(TextUtils.isEmpty(et_calc.getText())){
                    return;
                }lastIsOperator = false;
                firstNumber=-firstNumber;
                sencondNumber=-sencondNumber;
                lastOperators="=";
             break;
